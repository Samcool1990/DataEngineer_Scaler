...
WORDCOUNT_JAR = (
    'gs://scaler-dsml-sql-373609/appleresult.jar'
)

# Path to input file for Hadoop job.
hadoop_input_path = models.Variable.get('dags_folder') + '/SalesApple2017-18.csv'
# Path to input file for bash
bash_input_path = '/home/airflow/gcs/dags/SalesApple2017-18.csv'
#bash_input_path = 'gs://asia-east2-pipeline-demo-0d1160fe-bucket/dags/SalesApple2017-18.csv'
